export function About() {
    return (
        <div className="transition-all duration-500 ease-in-out bg-stone-900 flex flex-col justify-center pt-24 pb-8" id='about'>
            ...
            <p className="transition-all duration-500 ease-in-out  text-stone-400 text-center mx-auto w-11/12 sm:w-3/4 md:w-1/2 lg:w-2/5">I began my programming adventure during my academic years. Initially, making a 2-D platformer game piqued my interest, which led me to delve deeply into JavaScript. This experience helped me craft numerous dynamic applications, continuously honing my abilities and fostering a true passion for coding.
                <br></br>
                <br></br>
