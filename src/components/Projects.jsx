    ...
    const projectData = [
        {
            ...
            imageUrl: "https://res.cloudinary.com/dxwlsrgwj/image/upload/v1713243486/cld-sample-5.jpg",
        ...
        },
        {
            id: 3,
            name: "Project Three",
            description: "This is a brief description of Project Thre.",
            imageUrl: "https://res.cloudinary.com/dxwlsrgwj/image/upload/v1713243486/cld-sample-5.jpg",
            source:"#",
            demo:"#"
        },
        ...
        <div className="bg-stone-900 w-full h-screen pt-8" id="projects">
            ...
            <motion.div ref={ref} variants={container} initial="hidden" animate={isInView ? "visible" : "hidden"} className="bg-stone-900 flex flex-wrap justify-center items-start pt-8 px-72 overflow-auto w-full">
                {projectData.map(project => (
                    <motion.div key={project.id} variants={item} whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="flex flex-col z-10 w-1/2 p-8">
                        <div className="bg-stone-800 hover:bg-stone-700 text-white  p-5 rounded-lg shadow-lg">
                            <img src={project.imageUrl} alt={project.name} className="w-full h-40 object-cover rounded" />
